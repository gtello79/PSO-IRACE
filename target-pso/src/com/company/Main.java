...
public class Main {
    ...
    public static Pair<String,String> getInstanceById(Integer index) throws FileNotFoundException {
        ...
        String indexFile = "target-pso/src/data/index_instances.txt";
        ...
        folder_coord = System.getProperty("user.dir")+"/target-pso/src/data/"+folder_coord+"/";
    ...
    public static Vector<Volumen> createVolumes(String org_filename) throws FileNotFoundException {
        ...
        for(String orgFile: orgFiles){
            String pathToIrace = System.getProperty("user.dir")+"/target-pso/src/"+orgFile;
            Volumen to_add = new Volumen(pathToIrace);
            Volumes.add(to_add);
        }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        HashMap<String, String> params = mappingArg(args);        //Instance 0-70-140-210-280 CERR PACKAGE
        int instanceId = 71;
        ...
        */
        ...
        Swarm swarm = new Swarm(w, Zmin, Zmax, maxApertures, max_intensity, initial_intensity, step_intensity, open_apertures, setup, diffSetup, volumes, collimator,
                                ...
                                c1Intensity, c2Intensity, inerIntensity, cnIntensity, size, iter);
